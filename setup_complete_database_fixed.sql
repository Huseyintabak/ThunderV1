-- ThunderV1 Üretim Yönetim Sistemi - Tam Veritabanı Kurulumu (Düzeltilmiş)
-- V1.6.0 - Tüm Fazlar
...
-- Üretim planları tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Plan detayları tablosu (eski tabloyu sil ve yeniden oluştur)
DROP TABLE IF EXISTS production_plan_details CASCADE;
...
-- Kaynak yönetimi tablosu (eski tabloyu sil ve yeniden oluştur)
DROP TABLE IF EXISTS resource_management CASCADE;
...
-- Üretim zamanlaması tablosu (eski tabloyu sil ve yeniden oluştur)
DROP TABLE IF EXISTS production_scheduling CASCADE;
...
-- Sipariş yönetimi tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Sipariş detayları tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Kapasite planlama tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Bildirim türleri tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Bildirimler tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Uyarı kuralları tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Uyarı geçmişi tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Kullanıcı bildirim tercihleri tablosu (eski tabloyu sil ve yeniden oluştur)
...
-- Bildirim şablonları tablosu (eski tabloyu sil ve yeniden oluştur)
...
CREATE INDEX IF NOT EXISTS idx_production_plan_details_dates ON production_plan_details(planned_start, planned_end);
...
CREATE POLICY "quality_checkpoints_select_policy" ON quality_checkpoints FOR SELECT USING (true);
DROP POLICY IF EXISTS "quality_checkpoints_insert_policy" ON quality_checkpoints;
CREATE POLICY "quality_checkpoints_insert_policy" ON quality_checkpoints FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "quality_checkpoints_update_policy" ON quality_checkpoints;
CREATE POLICY "quality_checkpoints_update_policy" ON quality_checkpoints FOR UPDATE USING (true);
DROP POLICY IF EXISTS "quality_checkpoints_delete_policy" ON quality_checkpoints;
CREATE POLICY "quality_checkpoints_delete_policy" ON quality_checkpoints FOR DELETE USING (true);

-- Quality checks RLS
ALTER TABLE quality_checks ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "quality_checks_select_policy" ON quality_checks;
CREATE POLICY "quality_checks_select_policy" ON quality_checks FOR SELECT USING (true);
DROP POLICY IF EXISTS "quality_checks_insert_policy" ON quality_checks;
CREATE POLICY "quality_checks_insert_policy" ON quality_checks FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "quality_checks_update_policy" ON quality_checks;
CREATE POLICY "quality_checks_update_policy" ON quality_checks FOR UPDATE USING (true);
DROP POLICY IF EXISTS "quality_checks_delete_policy" ON quality_checks;
CREATE POLICY "quality_checks_delete_policy" ON quality_checks FOR DELETE USING (true);
...
CREATE POLICY "quality_standards_select_policy" ON quality_standards FOR SELECT USING (true);
DROP POLICY IF EXISTS "quality_standards_insert_policy" ON quality_standards;
CREATE POLICY "quality_standards_insert_policy" ON quality_standards FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "quality_standards_update_policy" ON quality_standards;
CREATE POLICY "quality_standards_update_policy" ON quality_standards FOR UPDATE USING (true);
DROP POLICY IF EXISTS "quality_standards_delete_policy" ON quality_standards;
CREATE POLICY "quality_standards_delete_policy" ON quality_standards FOR DELETE USING (true);
...
CREATE POLICY "quality_reports_select_policy" ON quality_reports FOR SELECT USING (true);
DROP POLICY IF EXISTS "quality_reports_insert_policy" ON quality_reports;
CREATE POLICY "quality_reports_insert_policy" ON quality_reports FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "quality_reports_update_policy" ON quality_reports;
CREATE POLICY "quality_reports_update_policy" ON quality_reports FOR UPDATE USING (true);
DROP POLICY IF EXISTS "quality_reports_delete_policy" ON quality_reports;
CREATE POLICY "quality_reports_delete_policy" ON quality_reports FOR DELETE USING (true);

-- Production plans RLS
ALTER TABLE production_plans ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "production_plans_select_policy" ON production_plans;
CREATE POLICY "production_plans_select_policy" ON production_plans FOR SELECT USING (true);
DROP POLICY IF EXISTS "production_plans_insert_policy" ON production_plans;
CREATE POLICY "production_plans_insert_policy" ON production_plans FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "production_plans_update_policy" ON production_plans;
CREATE POLICY "production_plans_update_policy" ON production_plans FOR UPDATE USING (true);
DROP POLICY IF EXISTS "production_plans_delete_policy" ON production_plans;
CREATE POLICY "production_plans_delete_policy" ON production_plans FOR DELETE USING (true);
...
CREATE POLICY "production_plan_details_select_policy" ON production_plan_details FOR SELECT USING (true);
DROP POLICY IF EXISTS "production_plan_details_insert_policy" ON production_plan_details;
CREATE POLICY "production_plan_details_insert_policy" ON production_plan_details FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "production_plan_details_update_policy" ON production_plan_details;
CREATE POLICY "production_plan_details_update_policy" ON production_plan_details FOR UPDATE USING (true);
DROP POLICY IF EXISTS "production_plan_details_delete_policy" ON production_plan_details;
CREATE POLICY "production_plan_details_delete_policy" ON production_plan_details FOR DELETE USING (true);
...
CREATE POLICY "resource_management_select_policy" ON resource_management FOR SELECT USING (true);
DROP POLICY IF EXISTS "resource_management_insert_policy" ON resource_management;
CREATE POLICY "resource_management_insert_policy" ON resource_management FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "resource_management_update_policy" ON resource_management;
CREATE POLICY "resource_management_update_policy" ON resource_management FOR UPDATE USING (true);
DROP POLICY IF EXISTS "resource_management_delete_policy" ON resource_management;
CREATE POLICY "resource_management_delete_policy" ON resource_management FOR DELETE USING (true);
...
CREATE POLICY "production_scheduling_select_policy" ON production_scheduling FOR SELECT USING (true);
DROP POLICY IF EXISTS "production_scheduling_insert_policy" ON production_scheduling;
CREATE POLICY "production_scheduling_insert_policy" ON production_scheduling FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "production_scheduling_update_policy" ON production_scheduling;
CREATE POLICY "production_scheduling_update_policy" ON production_scheduling FOR UPDATE USING (true);
DROP POLICY IF EXISTS "production_scheduling_delete_policy" ON production_scheduling;
CREATE POLICY "production_scheduling_delete_policy" ON production_scheduling FOR DELETE USING (true);
...
CREATE POLICY "order_management_select_policy" ON order_management FOR SELECT USING (true);
DROP POLICY IF EXISTS "order_management_insert_policy" ON order_management;
CREATE POLICY "order_management_insert_policy" ON order_management FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "order_management_update_policy" ON order_management;
CREATE POLICY "order_management_update_policy" ON order_management FOR UPDATE USING (true);
DROP POLICY IF EXISTS "order_management_delete_policy" ON order_management;
CREATE POLICY "order_management_delete_policy" ON order_management FOR DELETE USING (true);
...
CREATE POLICY "capacity_planning_select_policy" ON capacity_planning FOR SELECT USING (true);
DROP POLICY IF EXISTS "capacity_planning_insert_policy" ON capacity_planning;
CREATE POLICY "capacity_planning_insert_policy" ON capacity_planning FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "capacity_planning_update_policy" ON capacity_planning;
CREATE POLICY "capacity_planning_update_policy" ON capacity_planning FOR UPDATE USING (true);
DROP POLICY IF EXISTS "capacity_planning_delete_policy" ON capacity_planning;
CREATE POLICY "capacity_planning_delete_policy" ON capacity_planning FOR DELETE USING (true);
...
DROP POLICY IF EXISTS "notification_types_insert_policy" ON notification_types;
CREATE POLICY "notification_types_insert_policy" ON notification_types FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "notification_types_update_policy" ON notification_types;
CREATE POLICY "notification_types_update_policy" ON notification_types FOR UPDATE USING (true);
DROP POLICY IF EXISTS "notification_types_delete_policy" ON notification_types;
CREATE POLICY "notification_types_delete_policy" ON notification_types FOR DELETE USING (true);
...
CREATE POLICY "alert_history_select_policy" ON alert_history FOR SELECT USING (true);
DROP POLICY IF EXISTS "alert_history_insert_policy" ON alert_history;
CREATE POLICY "alert_history_insert_policy" ON alert_history FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "alert_history_update_policy" ON alert_history;
CREATE POLICY "alert_history_update_policy" ON alert_history FOR UPDATE USING (true);
DROP POLICY IF EXISTS "alert_history_delete_policy" ON alert_history;
CREATE POLICY "alert_history_delete_policy" ON alert_history FOR DELETE USING (true);

-- User notification preferences RLS
ALTER TABLE user_notification_preferences ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "user_notification_preferences_select_policy" ON user_notification_preferences;
CREATE POLICY "user_notification_preferences_select_policy" ON user_notification_preferences FOR SELECT USING (true);
DROP POLICY IF EXISTS "user_notification_preferences_insert_policy" ON user_notification_preferences;
CREATE POLICY "user_notification_preferences_insert_policy" ON user_notification_preferences FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "user_notification_preferences_update_policy" ON user_notification_preferences;
CREATE POLICY "user_notification_preferences_update_policy" ON user_notification_preferences FOR UPDATE USING (true);
DROP POLICY IF EXISTS "user_notification_preferences_delete_policy" ON user_notification_preferences;
CREATE POLICY "user_notification_preferences_delete_policy" ON user_notification_preferences FOR DELETE USING (true);
...
CREATE POLICY "notification_templates_select_policy" ON notification_templates FOR SELECT USING (true);
DROP POLICY IF EXISTS "notification_templates_insert_policy" ON notification_templates;
CREATE POLICY "notification_templates_insert_policy" ON notification_templates FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "notification_templates_update_policy" ON notification_templates;
CREATE POLICY "notification_templates_update_policy" ON notification_templates FOR UPDATE USING (true);
DROP POLICY IF EXISTS "notification_templates_delete_policy" ON notification_templates;
CREATE POLICY "notification_templates_delete_policy" ON notification_templates FOR DELETE USING (true);
...
('Üretim Başladı Şablonu', 
 ...
 '["production_id", "product_name", "quantity", "operator", "start_time"]'::jsonb),
...
('Kalite Hatası Şablonu',
 ...
 '["production_id", "error_message", "checkpoint_name", "operator", "check_time"]'::jsonb),
...
('Düşük Stok Şablonu',
 ...
 '["product_name", "current_quantity", "min_quantity"]'::jsonb)
ON CONFLICT DO NOTHING;
